...
\caption{Corridor flow vs.\ thermal limit (top) and state of charge of the two BESS (bottom), case D with the explicit rule; bands mark the high-usage ($\sigma_t=1$) and low-usage ($\sigma_t=0$) stages. End-of-hour values; the cycle closes between $e_{b,0}$ and the end of hour 24, as in \eqref{eq:soc}.}
\label{fig:corridor}
\end{figure}
